...
import { addSmurf, errorSmurf } from './../actions';

const AddForm = ({ addSmurf, errorSmurf, errorMessage }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (state.name === '' || state.position === '' || state.nickname === '') {
      errorSmurf('Name, position and nickname fields are required.');
    } else {
      addSmurf(state);
      setState({
        name: '',
...
export default connect(mapStateToProps, { errorSmurf, addSmurf })(AddForm);
